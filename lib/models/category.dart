...
final List<Category> categories = [
  Category(9,"Activities & Event", icon: FontAwesomeIcons.globeAsia),
  Category(10,"Choices", icon: FontAwesomeIcons.bookOpen),
  Category(11,"Communication", icon: FontAwesomeIcons.video),
  Category(12,"Decrebing People", icon: FontAwesomeIcons.music),
  Category(13,"Test", icon: FontAwesomeIcons.theaterMasks),
